// Supabase
export const SUPABASE_PUBLIC_HOSTNAME = "tsgaliwebpcrjwtcxzdp.supabase.co";
export const SUPABASE_PUBLIC_URL = `https://${SUPABASE_PUBLIC_HOSTNAME}`;
...
export const SUPABASE_HOUSES_PICTURES_BUCKET_ROOT_URL = `${SUPABASE_PUBLIC_URL}/storage/v1/object/public/houses-pictures`;
...
export const YWS_FACEBOOK_LINK =
